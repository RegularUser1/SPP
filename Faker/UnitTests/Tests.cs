...
namespace UnitTests
{
    public class Tests
    {
        ...
        private FakerConfig _fakerConfig = new();
        ...
        public void Test_FakerConfig()
        {
            ...
            Assert.NotNull(res);
            Assert.Equal(generator.Generate(), res.Int);
        }
        ...
        public void Test_NonDTOClass()
        {
            ...
            Assert.Equal(default, res!.DateTime);
        }

        [Fact]
        public void Test_Plugins()
        {
            _faker.AddGeneratorWithPlugin("Plugins/DateTimeGeneratorPlugin.dll");
