...
using FakerLab.Generators.BoolGenerators;
...
namespace FakerLab.Fakers
{
    public class Faker
    {
        private readonly Dictionary<Type, Type> _generators = new()
        {
            ...
            { typeof(bool), typeof(GeneratorBool) }
        };
        ...
        private object? GetInstance(Type type)
        {
            ...
            for (int i = 0; i < parameters.Length; i++)
            {
                ...
                constructorArgs[i] = _config.GetGeneratedValue(type, parameter.Name?.ToLower() ?? string.Empty)
        ...
        private object? GetGeneric(Type entityType, Type generatorType)
        {
            ...
            var generateMethod = genericGenerator.GetMethod("Generate")!;
