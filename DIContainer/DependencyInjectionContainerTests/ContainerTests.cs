...
namespace DependencyInjectionContainerTests
{
    public class ContainerTests
    {
        ...
        {
            _configuration.Register<IService1, Service1>(LifeCycle.Transient, "A");
            _configuration.Register<IService1, Service1Copy>(LifeCycle.Transient, "C");
        ...
        public void Test_NamedDependencyWithAnnotation()
        {
            _configuration.Register<IService1, Service1>(LifeCycle.Transient, "A");
            _configuration.Register<IService1, Service1Copy>(LifeCycle.Transient, "C");
            _configuration.Register<IRepository, DependsOnService1>(LifeCycle.Transient);
        ...
        {
            _configuration.Register<IService1, Service1>(LifeCycle.Transient, "A");
            _configuration.Register<IService1, Service1>(LifeCycle.Transient, "B");
            _configuration.Register<IService1, Service1Copy>(LifeCycle.Transient, "C");
        ...
        {
            _configuration.Register<IRepository, Repository>(LifeCycle.Transient);
            _configuration.Register<IServiceWithRepository<IRepository>,
                ServiceWithRepository<IRepository>>(LifeCycle.Transient);
        ...
        {
            _configuration.Register<IRepository, Repository>(LifeCycle.Transient);
            _configuration.Register(typeof(IServiceWithRepository<>), typeof(ServiceWithRepository<>), LifeCycle.Transient);
